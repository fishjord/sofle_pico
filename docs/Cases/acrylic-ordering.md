...
## layout: page title: Acrylic Ordering description: Sofle Pico Acrylic case ordering guide parent: Cases permalink: /cases/acrylic-ordering-guide nav_order: 5
...
1. Start at the [elecrow acrylic ordering page](https://www.elecrow.com/acrylic-cutting.html), and upload or drag and drop the `dxf.zip` file. (You'll have to add each plate to the order separately, there is no bulk upload option.)
1. Manually enter the dimensions to update pricing.
1. Adjust quantity, or leave at the default of 5.
1. Select 3mm for the acrylic.
1. The remainder of the checkout process is standard ecommerce stuff.
