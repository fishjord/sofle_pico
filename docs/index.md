...
## layout: page title: Overview nav_order: 1 image: /images/build_guide_pico/sofle_pico_v3.4_hero.jpeg
...
> The documentation is still in progress. You can see the punch list on the [status](/status) page.
...
Sofle Pico uses [QMK firmware](https://qmk.fm/).
