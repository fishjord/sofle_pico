...
## layout: page title: QMK description: Instructions for compiling QMK firmware for the Sofle Pico permalink: flashing/qmk parent: Flashing nav_order: 3
...
- Clone [https://github.com/qmk/qmk_firmware](https://github.com/qmk/qmk_firmware)
